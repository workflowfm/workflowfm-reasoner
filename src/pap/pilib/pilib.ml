...
let scala_deploy separator path package project proc deps main java =
  let is_atomic x = x.Proc.actions == [] in
...
let scala_deploy_print separator path package project proc deps main java =
  let overwrite,optional = scala_deploy separator path package project proc deps main java
